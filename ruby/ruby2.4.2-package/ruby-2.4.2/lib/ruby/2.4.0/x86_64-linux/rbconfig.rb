...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/goodrain/ruby-2.4.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/goodrain/ruby-2.4.2' '--build=x86_64-linux-gnu' '--disable-install-doc' '--enable-shared' 'build_alias=x86_64-linux-gnu'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/goodrain/ruby-2.4.2"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (Debian 6.3.0-18) 6.3.0 20170516\nCopyright (C) 2016 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
